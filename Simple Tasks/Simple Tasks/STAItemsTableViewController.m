...
{
    STAEditItemViewController * addNewItemVC = [[STAEditItemViewController alloc] init];
    
//    addNewItemVC.newitems = items;
...
//// "when you select a row in a cell, what is going to happen with it?" - Heidi
